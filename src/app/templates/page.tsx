...
const TEMPLATES_DESCRIPTION =
  "Free retrospective templates for agile teams: Start Stop Continue, Good Bad Start Stop, Mad Sad Glad, the 4 Ls, and Sailboat. What each format surfaces, when to use it, and a board you can start in one click. No sign-up.";
    ...
    <>
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 pt-8 pb-12 sm:px-6 sm:pt-12 sm:pb-16">
        ...
        <p className="mt-4 text-[15px] leading-relaxed text-mist-500">
          The format decides what the team notices. Five that cover most retros:
